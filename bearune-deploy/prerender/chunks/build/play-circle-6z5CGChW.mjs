...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    ...
    createElementVNode("path", { d: "m10 8 6 4-6 4V8z" }, null, -1)
  ]));
}
const playCircle = { render() {
  return h(NuxtIcon, { icon: { render }, name: "play-circle" });
} };

export { playCircle as default, render };
//# sourceMappingURL=play-circle-6z5CGChW.mjs.map
