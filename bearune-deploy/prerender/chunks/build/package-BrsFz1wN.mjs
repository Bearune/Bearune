...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "m16.5 9.4-9-5.19M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z" }, null, -1),
    createElementVNode("path", { d: "M3.27 6.96 12 12.01l8.73-5.05M12 22.08V12" }, null, -1)
  ]));
}
const _package = { render() {
  return h(NuxtIcon, { icon: { render }, name: "package" });
} };

export { _package as default, render };
//# sourceMappingURL=package-BrsFz1wN.mjs.map
