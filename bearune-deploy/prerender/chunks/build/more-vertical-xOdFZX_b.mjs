...
const moreVertical = { render() {
  return h(NuxtIcon, { icon: { render }, name: "more-vertical" });
} };

export { moreVertical as default, render };
//# sourceMappingURL=more-vertical-xOdFZX_b.mjs.map
