...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "m7 7 10 10M17 7v10H7" }, null, -1)
  ]));
}
const arrowDownRight = { render() {
  return h(NuxtIcon, { icon: { render }, name: "arrow-down-right" });
} };

export { arrowDownRight as default, render };
//# sourceMappingURL=arrow-down-right-DDcfWGHG.mjs.map
