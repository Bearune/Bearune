...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M1 4v6h6" }, null, -1),
    createElementVNode("path", { d: "M3.51 15a9 9 0 1 0 2.13-9.36L1 10" }, null, -1)
  ]));
}
const rotateCcw = { render() {
  return h(NuxtIcon, { icon: { render }, name: "rotate-ccw" });
} };

export { rotateCcw as default, render };
//# sourceMappingURL=rotate-ccw-BY8PZD4k.mjs.map
