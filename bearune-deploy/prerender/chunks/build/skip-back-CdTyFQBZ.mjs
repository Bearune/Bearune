...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M19 20 9 12l10-8v16zM5 19V5" }, null, -1)
  ]));
}
const skipBack = { render() {
  return h(NuxtIcon, { icon: { render }, name: "skip-back" });
} };

export { skipBack as default, render };
//# sourceMappingURL=skip-back-CdTyFQBZ.mjs.map
