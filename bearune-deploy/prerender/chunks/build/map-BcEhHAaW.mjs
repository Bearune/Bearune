...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M1 6v16l7-4 8 4 7-4V2l-7 4-8-4-7 4zM8 2v16M16 6v16" }, null, -1)
  ]));
}
const map = { render() {
  return h(NuxtIcon, { icon: { render }, name: "map" });
} };

export { map as default, render };
//# sourceMappingURL=map-BcEhHAaW.mjs.map
