...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "m18 15-6-6-6 6" }, null, -1)
  ]));
}
const chevronUp = { render() {
  return h(NuxtIcon, { icon: { render }, name: "chevron-up" });
} };

export { chevronUp as default, render };
//# sourceMappingURL=chevron-up-DngUcn8i.mjs.map
