...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    ...
    createElementVNode("path", { d: "M1.05 12H7M17.01 12h5.95" }, null, -1)
  ]));
}
const gitCommit = { render() {
  return h(NuxtIcon, { icon: { render }, name: "git-commit" });
} };

export { gitCommit as default, render };
//# sourceMappingURL=git-commit-D6RmxRT7.mjs.map
