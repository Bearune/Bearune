...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    ...
    createElementVNode("path", { d: "M7 2v20M17 2v20M2 12h20M2 7h5M2 17h5M17 17h5M17 7h5" }, null, -1)
  ]));
}
const film = { render() {
  return h(NuxtIcon, { icon: { render }, name: "film" });
} };

export { film as default, render };
//# sourceMappingURL=film-M0B26X91.mjs.map
