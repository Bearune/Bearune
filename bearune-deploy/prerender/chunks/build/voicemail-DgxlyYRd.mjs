...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    ...
    createElementVNode("path", { d: "M5.5 16h13" }, null, -1)
  ]));
}
const voicemail = { render() {
  return h(NuxtIcon, { icon: { render }, name: "voicemail" });
} };

export { voicemail as default, render };
//# sourceMappingURL=voicemail-DgxlyYRd.mjs.map
