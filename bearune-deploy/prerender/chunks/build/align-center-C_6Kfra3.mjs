...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M18 10H6M21 6H3M21 14H3M18 18H6" }, null, -1)
  ]));
}
const alignCenter = { render() {
  return h(NuxtIcon, { icon: { render }, name: "align-center" });
} };

export { alignCenter as default, render };
//# sourceMappingURL=align-center-C_6Kfra3.mjs.map
