...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M16 13v8M8 13v8M12 15v8M20 16.58A5 5 0 0 0 18 7h-1.26A8 8 0 1 0 4 15.25" }, null, -1)
  ]));
}
const cloudRain = { render() {
  return h(NuxtIcon, { icon: { render }, name: "cloud-rain" });
} };

export { cloudRain as default, render };
//# sourceMappingURL=cloud-rain-BvgV1CRd.mjs.map
