...
const moreHorizontal = { render() {
  return h(NuxtIcon, { icon: { render }, name: "more-horizontal" });
} };

export { moreHorizontal as default, render };
//# sourceMappingURL=more-horizontal-B7Fkp6qI.mjs.map
