...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M17 18a5 5 0 0 0-10 0M12 2v7M4.22 10.22l1.42 1.42M1 18h2M21 18h2M18.36 11.64l1.42-1.42M23 22H1M8 6l4-4 4 4" }, null, -1)
  ]));
}
const sunrise = { render() {
  return h(NuxtIcon, { icon: { render }, name: "sunrise" });
} };

export { sunrise as default, render };
//# sourceMappingURL=sunrise-BUBYJuX0.mjs.map
