...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M20 17.58A5 5 0 0 0 18 8h-1.26A8 8 0 1 0 4 16.25M8 16h.01M8 20h.01M12 18h.01M12 22h.01M16 16h.01M16 20h.01" }, null, -1)
  ]));
}
const cloudSnow = { render() {
  return h(NuxtIcon, { icon: { render }, name: "cloud-snow" });
} };

export { cloudSnow as default, render };
//# sourceMappingURL=cloud-snow-Dv_GjQKf.mjs.map
