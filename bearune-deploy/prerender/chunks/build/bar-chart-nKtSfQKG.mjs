...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M12 20V10M18 20V4M6 20v-4" }, null, -1)
  ]));
}
const barChart = { render() {
  return h(NuxtIcon, { icon: { render }, name: "bar-chart" });
} };

export { barChart as default, render };
//# sourceMappingURL=bar-chart-nKtSfQKG.mjs.map
