...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z" }, null, -1)
  ]));
}
const edit2 = { render() {
  return h(NuxtIcon, { icon: { render }, name: "edit-2" });
} };

export { edit2 as default, render };
//# sourceMappingURL=edit-2-Y9J6QQ6c.mjs.map
