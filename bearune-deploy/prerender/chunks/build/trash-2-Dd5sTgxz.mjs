...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M3 6h18M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2M10 11v6M14 11v6" }, null, -1)
  ]));
}
const trash2 = { render() {
  return h(NuxtIcon, { icon: { render }, name: "trash-2" });
} };

export { trash2 as default, render };
//# sourceMappingURL=trash-2-Dd5sTgxz.mjs.map
