...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    ...
    createElementVNode("path", { d: "M16 16s-1.5-2-4-2-4 2-4 2M9 9h.01M15 9h.01" }, null, -1)
  ]));
}
const frown = { render() {
  return h(NuxtIcon, { icon: { render }, name: "frown" });
} };

export { frown as default, render };
//# sourceMappingURL=frown-BDRPGDe3.mjs.map
