...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M14 9V5a3 3 0 0 0-3-3l-4 9v11h11.28a2 2 0 0 0 2-1.7l1.38-9a2 2 0 0 0-2-2.3zM7 22H4a2 2 0 0 1-2-2v-7a2 2 0 0 1 2-2h3" }, null, -1)
  ]));
}
const thumbsUp = { render() {
  return h(NuxtIcon, { icon: { render }, name: "thumbs-up" });
} };

export { thumbsUp as default, render };
//# sourceMappingURL=thumbs-up-CUJ8vo-b.mjs.map
