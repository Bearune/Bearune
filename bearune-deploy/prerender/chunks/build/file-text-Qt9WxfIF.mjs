...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" }, null, -1),
    createElementVNode("path", { d: "M14 2v6h6M16 13H8M16 17H8M10 9H8" }, null, -1)
  ]));
}
const fileText = { render() {
  return h(NuxtIcon, { icon: { render }, name: "file-text" });
} };

export { fileText as default, render };
//# sourceMappingURL=file-text-Qt9WxfIF.mjs.map
