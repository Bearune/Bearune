...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    ...
    createElementVNode("path", { d: "M9 9h6v6H9z" }, null, -1)
  ]));
}
const stopCircle = { render() {
  return h(NuxtIcon, { icon: { render }, name: "stop-circle" });
} };

export { stopCircle as default, render };
//# sourceMappingURL=stop-circle-CAJ4RnW7.mjs.map
