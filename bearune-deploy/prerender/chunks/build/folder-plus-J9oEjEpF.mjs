...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2zM12 11v6M9 14h6" }, null, -1)
  ]));
}
const folderPlus = { render() {
  return h(NuxtIcon, { icon: { render }, name: "folder-plus" });
} };

export { folderPlus as default, render };
//# sourceMappingURL=folder-plus-J9oEjEpF.mjs.map
