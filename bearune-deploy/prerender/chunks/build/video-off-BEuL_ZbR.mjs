...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M16 16v1a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2h2m5.66 0H14a2 2 0 0 1 2 2v3.34l1 1L23 7v10M1 1l22 22" }, null, -1)
  ]));
}
const videoOff = { render() {
  return h(NuxtIcon, { icon: { render }, name: "video-off" });
} };

export { videoOff as default, render };
//# sourceMappingURL=video-off-BEuL_ZbR.mjs.map
