...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M4 7V4h16v3M9 20h6M12 4v16" }, null, -1)
  ]));
}
const type = { render() {
  return h(NuxtIcon, { icon: { render }, name: "type" });
} };

export { type as default, render };
//# sourceMappingURL=type-DMhazgqp.mjs.map
