...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M22 2 11 13M22 2l-7 20-4-9-9-4 20-7z" }, null, -1)
  ]));
}
const send = { render() {
  return h(NuxtIcon, { icon: { render }, name: "send" });
} };

export { send as default, render };
//# sourceMappingURL=send-DfcZ9GEt.mjs.map
