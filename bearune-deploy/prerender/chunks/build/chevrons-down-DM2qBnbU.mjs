...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "m7 13 5 5 5-5M7 6l5 5 5-5" }, null, -1)
  ]));
}
const chevronsDown = { render() {
  return h(NuxtIcon, { icon: { render }, name: "chevrons-down" });
} };

export { chevronsDown as default, render };
//# sourceMappingURL=chevrons-down-DM2qBnbU.mjs.map
