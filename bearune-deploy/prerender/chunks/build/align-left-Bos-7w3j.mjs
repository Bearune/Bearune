...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M17 10H3M21 6H3M21 14H3M17 18H3" }, null, -1)
  ]));
}
const alignLeft = { render() {
  return h(NuxtIcon, { icon: { render }, name: "align-left" });
} };

export { alignLeft as default, render };
//# sourceMappingURL=align-left-Bos-7w3j.mjs.map
