...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M12 5v14M19 12l-7 7-7-7" }, null, -1)
  ]));
}
const arrowDown = { render() {
  return h(NuxtIcon, { icon: { render }, name: "arrow-down" });
} };

export { arrowDown as default, render };
//# sourceMappingURL=arrow-down-D-lsbJws.mjs.map
