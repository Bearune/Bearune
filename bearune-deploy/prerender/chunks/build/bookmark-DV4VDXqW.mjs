...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "m19 21-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z" }, null, -1)
  ]));
}
const bookmark = { render() {
  return h(NuxtIcon, { icon: { render }, name: "bookmark" });
} };

export { bookmark as default, render };
//# sourceMappingURL=bookmark-DV4VDXqW.mjs.map
