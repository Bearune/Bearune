...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "m11 17-5-5 5-5M18 17l-5-5 5-5" }, null, -1)
  ]));
}
const chevronsLeft = { render() {
  return h(NuxtIcon, { icon: { render }, name: "chevrons-left" });
} };

export { chevronsLeft as default, render };
//# sourceMappingURL=chevrons-left-D5vfFdVB.mjs.map
