...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    ...
    createElementVNode("path", { d: "M8 14s1.5 2 4 2 4-2 4-2M9 9h.01M15 9h.01" }, null, -1)
  ]));
}
const smile = { render() {
  return h(NuxtIcon, { icon: { render }, name: "smile" });
} };

export { smile as default, render };
//# sourceMappingURL=smile-BmuHLHC4.mjs.map
