...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    ...
    createElementVNode("path", { d: "M20 8v6M23 11h-6" }, null, -1)
  ]));
}
const userPlus = { render() {
  return h(NuxtIcon, { icon: { render }, name: "user-plus" });
} };

export { userPlus as default, render };
//# sourceMappingURL=user-plus-xDhGLvKv.mjs.map
