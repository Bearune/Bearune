...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    ...
    createElementVNode("path", { d: "M12 8v8M8 12h8" }, null, -1)
  ]));
}
const plusCircle = { render() {
  return h(NuxtIcon, { icon: { render }, name: "plus-circle" });
} };

export { plusCircle as default, render };
//# sourceMappingURL=plus-circle-CiHjGOL1.mjs.map
