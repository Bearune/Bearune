...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "m12 2 7 19-7-4-7 4 7-19z" }, null, -1)
  ]));
}
const navigation2 = { render() {
  return h(NuxtIcon, { icon: { render }, name: "navigation-2" });
} };

export { navigation2 as default, render };
//# sourceMappingURL=navigation-2-oJ78jFjD.mjs.map
