...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6M15 3h6v6M10 14 21 3" }, null, -1)
  ]));
}
const externalLink = { render() {
  return h(NuxtIcon, { icon: { render }, name: "external-link" });
} };

export { externalLink as default, render };
//# sourceMappingURL=external-link-Bj7JDPfv.mjs.map
