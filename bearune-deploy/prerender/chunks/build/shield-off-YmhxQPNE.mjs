...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M19.69 14a6.9 6.9 0 0 0 .31-2V5l-8-3-3.16 1.18M4.73 4.73 4 5v7c0 6 8 10 8 10a20.29 20.29 0 0 0 5.62-4.38M1 1l22 22" }, null, -1)
  ]));
}
const shieldOff = { render() {
  return h(NuxtIcon, { icon: { render }, name: "shield-off" });
} };

export { shieldOff as default, render };
//# sourceMappingURL=shield-off-YmhxQPNE.mjs.map
