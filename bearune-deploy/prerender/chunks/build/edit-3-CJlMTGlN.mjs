...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M12 20h9M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z" }, null, -1)
  ]));
}
const edit3 = { render() {
  return h(NuxtIcon, { icon: { render }, name: "edit-3" });
} };

export { edit3 as default, render };
//# sourceMappingURL=edit-3-CJlMTGlN.mjs.map
