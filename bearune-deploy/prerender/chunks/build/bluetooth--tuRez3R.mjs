...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "m6.5 6.5 11 11L12 23V1l5.5 5.5-11 11" }, null, -1)
  ]));
}
const bluetooth = { render() {
  return h(NuxtIcon, { icon: { render }, name: "bluetooth" });
} };

export { bluetooth as default, render };
//# sourceMappingURL=bluetooth--tuRez3R.mjs.map
