...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    ...
    createElementVNode("path", { d: "M8 21h8M12 17v4" }, null, -1)
  ]));
}
const monitor = { render() {
  return h(NuxtIcon, { icon: { render }, name: "monitor" });
} };

export { monitor as default, render };
//# sourceMappingURL=monitor-BVWCJnqo.mjs.map
