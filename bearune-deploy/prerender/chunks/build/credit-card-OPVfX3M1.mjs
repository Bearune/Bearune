...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    ...
    createElementVNode("path", { d: "M1 10h22" }, null, -1)
  ]));
}
const creditCard = { render() {
  return h(NuxtIcon, { icon: { render }, name: "credit-card" });
} };

export { creditCard as default, render };
//# sourceMappingURL=credit-card-OPVfX3M1.mjs.map
