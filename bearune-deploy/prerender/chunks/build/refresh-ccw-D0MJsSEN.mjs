...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M1 4v6h6M23 20v-6h-6" }, null, -1),
    createElementVNode("path", { d: "M20.49 9A9 9 0 0 0 5.64 5.64L1 10m22 4-4.64 4.36A9 9 0 0 1 3.51 15" }, null, -1)
  ]));
}
const refreshCcw = { render() {
  return h(NuxtIcon, { icon: { render }, name: "refresh-ccw" });
} };

export { refreshCcw as default, render };
//# sourceMappingURL=refresh-ccw-D0MJsSEN.mjs.map
