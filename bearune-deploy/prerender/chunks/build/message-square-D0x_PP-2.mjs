...
const messageSquare = { render() {
  return h(NuxtIcon, { icon: { render }, name: "message-square" });
} };

export { messageSquare as default, render };
//# sourceMappingURL=message-square-D0x_PP-2.mjs.map
