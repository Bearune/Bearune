...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M3 18v-6a9 9 0 0 1 18 0v6" }, null, -1),
    createElementVNode("path", { d: "M21 19a2 2 0 0 1-2 2h-1a2 2 0 0 1-2-2v-3a2 2 0 0 1 2-2h3zM3 19a2 2 0 0 0 2 2h1a2 2 0 0 0 2-2v-3a2 2 0 0 0-2-2H3z" }, null, -1)
  ]));
}
const headphones = { render() {
  return h(NuxtIcon, { icon: { render }, name: "headphones" });
} };

export { headphones as default, render };
//# sourceMappingURL=headphones-DlOk8VOt.mjs.map
