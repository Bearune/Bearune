...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M6 4h4v16H6zM14 4h4v16h-4z" }, null, -1)
  ]));
}
const pause = { render() {
  return h(NuxtIcon, { icon: { render }, name: "pause" });
} };

export { pause as default, render };
//# sourceMappingURL=pause-DbMoNmdz.mjs.map
