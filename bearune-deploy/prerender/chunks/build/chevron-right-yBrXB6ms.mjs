...
const chevronRight = { render() {
  return h(NuxtIcon, { icon: { render }, name: "chevron-right" });
} };

export { chevronRight as default, render };
//# sourceMappingURL=chevron-right-yBrXB6ms.mjs.map
