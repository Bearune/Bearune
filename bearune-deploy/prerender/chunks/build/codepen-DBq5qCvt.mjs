...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "m12 2 10 6.5v7L12 22 2 15.5v-7L12 2zM12 22v-6.5" }, null, -1),
    createElementVNode("path", { d: "m22 8.5-10 7-10-7" }, null, -1),
    createElementVNode("path", { d: "m2 15.5 10-7 10 7M12 2v6.5" }, null, -1)
  ]));
}
const codepen = { render() {
  return h(NuxtIcon, { icon: { render }, name: "codepen" });
} };

export { codepen as default, render };
//# sourceMappingURL=codepen-DBq5qCvt.mjs.map
