...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "m23 18-9.5-9.5-5 5L1 6" }, null, -1),
    createElementVNode("path", { d: "M17 18h6v-6" }, null, -1)
  ]));
}
const trendingDown = { render() {
  return h(NuxtIcon, { icon: { render }, name: "trending-down" });
} };

export { trendingDown as default, render };
//# sourceMappingURL=trending-down-BVa8AppB.mjs.map
