...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    ...
    createElementVNode("path", { d: "M21 12c0 1.66-4 3-9 3s-9-1.34-9-3" }, null, -1),
    createElementVNode("path", { d: "M3 5v14c0 1.66 4 3 9 3s9-1.34 9-3V5" }, null, -1)
  ]));
}
const database = { render() {
  return h(NuxtIcon, { icon: { render }, name: "database" });
} };

export { database as default, render };
//# sourceMappingURL=database-B_tbGDLL.mjs.map
