...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    ...
    createElementVNode("path", { d: "M23 13v-2" }, null, -1)
  ]));
}
const battery = { render() {
  return h(NuxtIcon, { icon: { render }, name: "battery" });
} };

export { battery as default, render };
//# sourceMappingURL=battery-DLw5HgpB.mjs.map
