...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "m12 2 3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" }, null, -1)
  ]));
}
const star = { render() {
  return h(NuxtIcon, { icon: { render }, name: "star" });
} };

export { star as default, render };
//# sourceMappingURL=star-agqc1ULY.mjs.map
