...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M5 17H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2h-1" }, null, -1),
    createElementVNode("path", { d: "m12 15 5 6H7l5-6z" }, null, -1)
  ]));
}
const airplay = { render() {
  return h(NuxtIcon, { icon: { render }, name: "airplay" });
} };

export { airplay as default, render };
//# sourceMappingURL=airplay-CdWs68J7.mjs.map
