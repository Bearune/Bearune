...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "m12 19 7-7 3 3-7 7-3-3z" }, null, -1),
    createElementVNode("path", { d: "m18 13-1.5-7.5L2 2l3.5 14.5L13 18l5-5zM2 2l7.586 7.586" }, null, -1),
...
const penTool = { render() {
  return h(NuxtIcon, { icon: { render }, name: "pen-tool" });
} };

export { penTool as default, render };
//# sourceMappingURL=pen-tool-Dwr7lF9Q.mjs.map
