...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M12.41 6.75 13 2l-2.43 2.92M18.57 12.91 21 10h-5.34M8 8l-5 6h9l-1 8 5-6M1 1l22 22" }, null, -1)
  ]));
}
const zapOff = { render() {
  return h(NuxtIcon, { icon: { render }, name: "zap-off" });
} };

export { zapOff as default, render };
//# sourceMappingURL=zap-off-kGGAlTol.mjs.map
