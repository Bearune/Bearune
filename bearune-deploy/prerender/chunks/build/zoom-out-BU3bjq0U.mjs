...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    ...
    createElementVNode("path", { d: "m21 21-4.35-4.35M8 11h6" }, null, -1)
  ]));
}
const zoomOut = { render() {
  return h(NuxtIcon, { icon: { render }, name: "zoom-out" });
} };

export { zoomOut as default, render };
//# sourceMappingURL=zoom-out-BU3bjq0U.mjs.map
