...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M12 1v22M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6" }, null, -1)
  ]));
}
const dollarSign = { render() {
  return h(NuxtIcon, { icon: { render }, name: "dollar-sign" });
} };

export { dollarSign as default, render };
//# sourceMappingURL=dollar-sign-CBx_T_4h.mjs.map
