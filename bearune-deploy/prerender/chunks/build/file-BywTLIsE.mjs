...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M13 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V9z" }, null, -1),
    createElementVNode("path", { d: "M13 2v7h7" }, null, -1)
  ]));
}
const file = { render() {
  return h(NuxtIcon, { icon: { render }, name: "file" });
} };

export { file as default, render };
//# sourceMappingURL=file-BywTLIsE.mjs.map
