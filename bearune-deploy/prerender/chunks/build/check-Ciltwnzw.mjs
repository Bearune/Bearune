...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M20 6 9 17l-5-5" }, null, -1)
  ]));
}
const check = { render() {
  return h(NuxtIcon, { icon: { render }, name: "check" });
} };

export { check as default, render };
//# sourceMappingURL=check-Ciltwnzw.mjs.map
