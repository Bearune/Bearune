...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M4 21v-7M4 10V3M12 21v-9M12 8V3M20 21v-5M20 12V3M1 14h6M9 8h6M17 16h6" }, null, -1)
  ]));
}
const sliders = { render() {
  return h(NuxtIcon, { icon: { render }, name: "sliders" });
} };

export { sliders as default, render };
//# sourceMappingURL=sliders-xBDl5pzO.mjs.map
