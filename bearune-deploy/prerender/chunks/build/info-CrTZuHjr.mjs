...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    ...
    createElementVNode("path", { d: "M12 16v-4M12 8h.01" }, null, -1)
  ]));
}
const info = { render() {
  return h(NuxtIcon, { icon: { render }, name: "info" });
} };

export { info as default, render };
//# sourceMappingURL=info-CrTZuHjr.mjs.map
