...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "m3 3 7.07 16.97 2.51-7.39 7.39-2.51L3 3zM13 13l6 6" }, null, -1)
  ]));
}
const mousePointer = { render() {
  return h(NuxtIcon, { icon: { render }, name: "mouse-pointer" });
} };

export { mousePointer as default, render };
//# sourceMappingURL=mouse-pointer-Do5viVKj.mjs.map
