...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    ...
    createElementVNode("path", { d: "M14 2v6h6M9 15h6" }, null, -1)
  ]));
}
const fileMinus = { render() {
  return h(NuxtIcon, { icon: { render }, name: "file-minus" });
} };

export { fileMinus as default, render };
//# sourceMappingURL=file-minus-DPXVpRB5.mjs.map
