...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M19 4h-9M14 20H5M15 4 9 20" }, null, -1)
  ]));
}
const italic = { render() {
  return h(NuxtIcon, { icon: { render }, name: "italic" });
} };

export { italic as default, render };
//# sourceMappingURL=italic-D_DgQp6g.mjs.map
