...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    ...
    createElementVNode("path", { d: "M3 9h18M9 21V9" }, null, -1)
  ]));
}
const layout = { render() {
  return h(NuxtIcon, { icon: { render }, name: "layout" });
} };

export { layout as default, render };
//# sourceMappingURL=layout-DeXBGI65.mjs.map
