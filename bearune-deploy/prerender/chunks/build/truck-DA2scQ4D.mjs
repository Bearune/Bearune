...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M1 3h15v13H1zM16 8h4l3 3v5h-7V8z" }, null, -1),
...
const truck = { render() {
  return h(NuxtIcon, { icon: { render }, name: "truck" });
} };

export { truck as default, render };
//# sourceMappingURL=truck-DA2scQ4D.mjs.map
