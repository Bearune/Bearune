...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M20.24 12.24a6 6 0 0 0-8.49-8.49L5 10.5V19h8.5zM16 8 2 22M17.5 15H9" }, null, -1)
  ]));
}
const feather = { render() {
  return h(NuxtIcon, { icon: { render }, name: "feather" });
} };

export { feather as default, render };
//# sourceMappingURL=feather-mEliSL0l.mjs.map
