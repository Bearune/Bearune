...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M12 3h7a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-7m0-18H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h7m0-18v18" }, null, -1)
  ]));
}
const columns = { render() {
  return h(NuxtIcon, { icon: { render }, name: "columns" });
} };

export { columns as default, render };
//# sourceMappingURL=columns-CmvB3wq0.mjs.map
