...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    ...
    createElementVNode("path", { d: "m21 21-4.35-4.35M11 8v6M8 11h6" }, null, -1)
  ]));
}
const zoomIn = { render() {
  return h(NuxtIcon, { icon: { render }, name: "zoom-in" });
} };

export { zoomIn as default, render };
//# sourceMappingURL=zoom-in-BrTPhnYk.mjs.map
