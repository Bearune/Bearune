...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M19 5 5 19" }, null, -1),
...
const percent = { render() {
  return h(NuxtIcon, { icon: { render }, name: "percent" });
} };

export { percent as default, render };
//# sourceMappingURL=percent-CXqvho1N.mjs.map
