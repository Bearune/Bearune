...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2" }, null, -1),
    createElementVNode("circle", {
      cx: "8.5",
      cy: "7",
      r: "4"
    }, null, -1),
    createElementVNode("path", { d: "m17 11 2 2 4-4" }, null, -1)
  ]));
}
const userCheck = { render() {
  return h(NuxtIcon, { icon: { render }, name: "user-check" });
} };

export { userCheck as default, render };
//# sourceMappingURL=user-check-D5yJFs-i.mjs.map
