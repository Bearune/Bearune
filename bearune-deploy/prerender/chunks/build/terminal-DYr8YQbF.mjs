...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "m4 17 6-6-6-6M12 19h8" }, null, -1)
  ]));
}
const terminal = { render() {
  return h(NuxtIcon, { icon: { render }, name: "terminal" });
} };

export { terminal as default, render };
//# sourceMappingURL=terminal-DYr8YQbF.mjs.map
