...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M23 19a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4l2-3h6l2 3h4a2 2 0 0 1 2 2z" }, null, -1),
...
const camera = { render() {
  return h(NuxtIcon, { icon: { render }, name: "camera" });
} };

export { camera as default, render };
//# sourceMappingURL=camera-CerYnlWk.mjs.map
