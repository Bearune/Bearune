...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4M17 8l-5-5-5 5M12 3v12" }, null, -1)
  ]));
}
const upload = { render() {
  return h(NuxtIcon, { icon: { render }, name: "upload" });
} };

export { upload as default, render };
//# sourceMappingURL=upload-fTsuVJxJ.mjs.map
