...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    ...
    createElementVNode("path", { d: "M12 6h.01" }, null, -1)
  ]));
}
const speaker = { render() {
  return h(NuxtIcon, { icon: { render }, name: "speaker" });
} };

export { speaker as default, render };
//# sourceMappingURL=speaker-DgKT4tCp.mjs.map
