...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M10.29 3.86 1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z" }, null, -1)
  ]));
}
const triangle = { render() {
  return h(NuxtIcon, { icon: { render }, name: "triangle" });
} };

export { triangle as default, render };
//# sourceMappingURL=triangle-CO8bjgqc.mjs.map
