...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M9 14 4 9l5-5" }, null, -1),
    createElementVNode("path", { d: "M20 20v-7a4 4 0 0 0-4-4H4" }, null, -1)
  ]));
}
const cornerUpLeft = { render() {
  return h(NuxtIcon, { icon: { render }, name: "corner-up-left" });
} };

export { cornerUpLeft as default, render };
//# sourceMappingURL=corner-up-left-D7IJUzF5.mjs.map
