...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M17 7 7 17M17 17H7V7" }, null, -1)
  ]));
}
const arrowDownLeft = { render() {
  return h(NuxtIcon, { icon: { render }, name: "arrow-down-left" });
} };

export { arrowDownLeft as default, render };
//# sourceMappingURL=arrow-down-left-CyLDqB5F.mjs.map
