...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "m23 7-7 5 7 5V7z" }, null, -1),
...
const video = { render() {
  return h(NuxtIcon, { icon: { render }, name: "video" });
} };

export { video as default, render };
//# sourceMappingURL=video-D4cqikIZ.mjs.map
