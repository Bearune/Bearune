...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M11 5 6 9H2v6h4l5 4V5z" }, null, -1)
  ]));
}
const volume = { render() {
  return h(NuxtIcon, { icon: { render }, name: "volume" });
} };

export { volume as default, render };
//# sourceMappingURL=volume-lSN31HAO.mjs.map
