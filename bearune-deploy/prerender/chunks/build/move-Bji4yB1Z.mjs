...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "m5 9-3 3 3 3M9 5l3-3 3 3M15 19l-3 3-3-3M19 9l3 3-3 3M2 12h20M12 2v20" }, null, -1)
  ]));
}
const move = { render() {
  return h(NuxtIcon, { icon: { render }, name: "move" });
} };

export { move as default, render };
//# sourceMappingURL=move-Bji4yB1Z.mjs.map
