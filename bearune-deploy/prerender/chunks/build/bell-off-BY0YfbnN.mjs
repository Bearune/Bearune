...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M13.73 21a2 2 0 0 1-3.46 0M18.63 13A17.89 17.89 0 0 1 18 8M6.26 6.26A5.86 5.86 0 0 0 6 8c0 7-3 9-3 9h14M18 8a6 6 0 0 0-9.33-5M1 1l22 22" }, null, -1)
  ]));
}
const bellOff = { render() {
  return h(NuxtIcon, { icon: { render }, name: "bell-off" });
} };

export { bellOff as default, render };
//# sourceMappingURL=bell-off-BY0YfbnN.mjs.map
