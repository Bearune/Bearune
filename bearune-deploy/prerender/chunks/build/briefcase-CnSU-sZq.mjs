...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    ...
    createElementVNode("path", { d: "M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16" }, null, -1)
  ]));
}
const briefcase = { render() {
  return h(NuxtIcon, { icon: { render }, name: "briefcase" });
} };

export { briefcase as default, render };
//# sourceMappingURL=briefcase-CnSU-sZq.mjs.map
