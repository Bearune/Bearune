...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "m12 2.69 5.66 5.66a8 8 0 1 1-11.31 0z" }, null, -1)
  ]));
}
const droplet = { render() {
  return h(NuxtIcon, { icon: { render }, name: "droplet" });
} };

export { droplet as default, render };
//# sourceMappingURL=droplet-CAElIHFF.mjs.map
