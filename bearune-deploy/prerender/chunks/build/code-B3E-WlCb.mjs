...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "m16 18 6-6-6-6M8 6l-6 6 6 6" }, null, -1)
  ]));
}
const code = { render() {
  return h(NuxtIcon, { icon: { render }, name: "code" });
} };

export { code as default, render };
//# sourceMappingURL=code-B3E-WlCb.mjs.map
