...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    ...
    createElementVNode("path", { d: "m15 9-6 6M9 9l6 6" }, null, -1)
  ]));
}
const xCircle = { render() {
  return h(NuxtIcon, { icon: { render }, name: "x-circle" });
} };

export { xCircle as default, render };
//# sourceMappingURL=x-circle-DTs43uj6.mjs.map
