...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M22 12H2M5.45 5.11 2 12v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-6l-3.45-6.89A2 2 0 0 0 16.76 4H7.24a2 2 0 0 0-1.79 1.11zM6 16h.01M10 16h.01" }, null, -1)
  ]));
}
const hardDrive = { render() {
  return h(NuxtIcon, { icon: { render }, name: "hard-drive" });
} };

export { hardDrive as default, render };
//# sourceMappingURL=hard-drive-CNEOygQ9.mjs.map
