...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M6 4h8a4 4 0 0 1 4 4 4 4 0 0 1-4 4H6zM6 12h9a4 4 0 0 1 4 4 4 4 0 0 1-4 4H6z" }, null, -1)
  ]));
}
const bold = { render() {
  return h(NuxtIcon, { icon: { render }, name: "bold" });
} };

export { bold as default, render };
//# sourceMappingURL=bold-C0kilZf2.mjs.map
