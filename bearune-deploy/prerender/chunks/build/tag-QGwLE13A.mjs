...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "m20.59 13.41-7.17 7.17a2 2 0 0 1-2.83 0L2 12V2h10l8.59 8.59a2 2 0 0 1 0 2.82zM7 7h.01" }, null, -1)
  ]));
}
const tag = { render() {
  return h(NuxtIcon, { icon: { render }, name: "tag" });
} };

export { tag as default, render };
//# sourceMappingURL=tag-QGwLE13A.mjs.map
