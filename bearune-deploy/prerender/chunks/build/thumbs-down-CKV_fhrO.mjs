...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M10 15v4a3 3 0 0 0 3 3l4-9V2H5.72a2 2 0 0 0-2 1.7l-1.38 9a2 2 0 0 0 2 2.3zm7-13h2.67A2.31 2.31 0 0 1 22 4v7a2.31 2.31 0 0 1-2.33 2H17" }, null, -1)
  ]));
}
const thumbsDown = { render() {
  return h(NuxtIcon, { icon: { render }, name: "thumbs-down" });
} };

export { thumbsDown as default, render };
//# sourceMappingURL=thumbs-down-CKV_fhrO.mjs.map
