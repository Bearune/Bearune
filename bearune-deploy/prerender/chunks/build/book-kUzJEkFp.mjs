...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M4 19.5A2.5 2.5 0 0 1 6.5 17H20" }, null, -1),
    createElementVNode("path", { d: "M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z" }, null, -1)
  ]));
}
const book = { render() {
  return h(NuxtIcon, { icon: { render }, name: "book" });
} };

export { book as default, render };
//# sourceMappingURL=book-kUzJEkFp.mjs.map
