...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M6 3v12" }, null, -1),
    ...
    createElementVNode("path", { d: "M18 9a9 9 0 0 1-9 9" }, null, -1)
  ]));
}
const gitBranch = { render() {
  return h(NuxtIcon, { icon: { render }, name: "git-branch" });
} };

export { gitBranch as default, render };
//# sourceMappingURL=git-branch-WfPN66QJ.mjs.map
