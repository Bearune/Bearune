...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M3 6h18M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2" }, null, -1)
  ]));
}
const trash = { render() {
  return h(NuxtIcon, { icon: { render }, name: "trash" });
} };

export { trash as default, render };
//# sourceMappingURL=trash-C88rPSIk.mjs.map
