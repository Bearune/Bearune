...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M18.36 6.64a9 9 0 1 1-12.73 0M12 2v10" }, null, -1)
  ]));
}
const power = { render() {
  return h(NuxtIcon, { icon: { render }, name: "power" });
} };

export { power as default, render };
//# sourceMappingURL=power-D8GQKDPg.mjs.map
