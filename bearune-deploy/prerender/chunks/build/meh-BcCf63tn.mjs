...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    ...
    createElementVNode("path", { d: "M8 15h8M9 9h.01M15 9h.01" }, null, -1)
  ]));
}
const meh = { render() {
  return h(NuxtIcon, { icon: { render }, name: "meh" });
} };

export { meh as default, render };
//# sourceMappingURL=meh-BcCf63tn.mjs.map
