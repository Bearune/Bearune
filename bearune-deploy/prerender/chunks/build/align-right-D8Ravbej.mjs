...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M21 10H7M21 6H3M21 14H3M21 18H7" }, null, -1)
  ]));
}
const alignRight = { render() {
  return h(NuxtIcon, { icon: { render }, name: "align-right" });
} };

export { alignRight as default, render };
//# sourceMappingURL=align-right-D8Ravbej.mjs.map
