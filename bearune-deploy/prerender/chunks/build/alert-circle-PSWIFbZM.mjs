...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    ...
    createElementVNode("path", { d: "M12 8v4M12 16h.01" }, null, -1)
  ]));
}
const alertCircle = { render() {
  return h(NuxtIcon, { icon: { render }, name: "alert-circle" });
} };

export { alertCircle as default, render };
//# sourceMappingURL=alert-circle-PSWIFbZM.mjs.map
