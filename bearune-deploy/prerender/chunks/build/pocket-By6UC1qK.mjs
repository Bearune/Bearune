...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M4 3h16a2 2 0 0 1 2 2v6a10 10 0 0 1-10 10A10 10 0 0 1 2 11V5a2 2 0 0 1 2-2z" }, null, -1),
    createElementVNode("path", { d: "m8 10 4 4 4-4" }, null, -1)
  ]));
}
const pocket = { render() {
  return h(NuxtIcon, { icon: { render }, name: "pocket" });
} };

export { pocket as default, render };
//# sourceMappingURL=pocket-By6UC1qK.mjs.map
