import { ref, mergeProps, unref, useSSRContext } from 'file://C:/bearuneBlog/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderClass, ssrRenderComponent, ssrInterpolate, ssrRenderSlot } from 'file://C:/bearuneBlog/node_modules/vue/server-renderer/index.mjs';
import { C as ChevronRight } from './chevron-right-CUbuOFpE.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "details-block mb-8 text-base-content text-base" }, _attrs))} data-v-9fe11b1e><div class="${ssrRenderClass([{ "btn-primary": unref(isOpen), "btn-secondary": !unref(isOpen) }, "btn px-4 py-2 flex items-center gap-2 cursor-pointer select-none"])}" data-v-9fe11b1e>`);
      _push(ssrRenderComponent(unref(ChevronRight), {
        class: [{ "rotate-90": unref(isOpen) }, "w-6 h-6 transition-transform duration-btn"]
      }, null, _parent));
      _push(`<span data-v-9fe11b1e>${ssrInterpolate(props.title)}</span></div>`);
      if (unref(isOpen)) {
        _push(`<div class="mt-2 p-4 border border-primary rounded-btn" data-v-9fe11b1e>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/content/DetailsBlock.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const DetailsBlock = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-9fe11b1e"]]);

export { DetailsBlock as default };
//# sourceMappingURL=DetailsBlock-ByXaTDr9.mjs.map
