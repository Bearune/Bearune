...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    ...
    createElementVNode("path", { d: "M6 21V9a9 9 0 0 0 9 9" }, null, -1)
  ]));
}
const gitMerge = { render() {
  return h(NuxtIcon, { icon: { render }, name: "git-merge" });
} };

export { gitMerge as default, render };
//# sourceMappingURL=git-merge-gJHPPV07.mjs.map
