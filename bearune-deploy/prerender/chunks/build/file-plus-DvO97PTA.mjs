...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    ...
    createElementVNode("path", { d: "M14 2v6h6M12 18v-6M9 15h6" }, null, -1)
  ]));
}
const filePlus = { render() {
  return h(NuxtIcon, { icon: { render }, name: "file-plus" });
} };

export { filePlus as default, render };
//# sourceMappingURL=file-plus-DvO97PTA.mjs.map
