...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    ...
    createElementVNode("path", { d: "m9 9 6 6M15 9l-6 6" }, null, -1)
  ]));
}
const xSquare = { render() {
  return h(NuxtIcon, { icon: { render }, name: "x-square" });
} };

export { xSquare as default, render };
//# sourceMappingURL=x-square-C-Fyrrne.mjs.map
