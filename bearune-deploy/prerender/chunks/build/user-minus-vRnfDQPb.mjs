...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    ...
    createElementVNode("path", { d: "M23 11h-6" }, null, -1)
  ]));
}
const userMinus = { render() {
  return h(NuxtIcon, { icon: { render }, name: "user-minus" });
} };

export { userMinus as default, render };
//# sourceMappingURL=user-minus-vRnfDQPb.mjs.map
