...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    ...
    createElementVNode("path", { d: "m12 8-4 4 4 4M16 12H8" }, null, -1)
  ]));
}
const arrowLeftCircle = { render() {
  return h(NuxtIcon, { icon: { render }, name: "arrow-left-circle" });
} };

export { arrowLeftCircle as default, render };
//# sourceMappingURL=arrow-left-circle-CKVsiPzZ.mjs.map
