...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "m9 10-5 5 5 5" }, null, -1),
    createElementVNode("path", { d: "M20 4v7a4 4 0 0 1-4 4H4" }, null, -1)
  ]));
}
const cornerDownLeft = { render() {
  return h(NuxtIcon, { icon: { render }, name: "corner-down-left" });
} };

export { cornerDownLeft as default, render };
//# sourceMappingURL=corner-down-left-CjylDgdG.mjs.map
