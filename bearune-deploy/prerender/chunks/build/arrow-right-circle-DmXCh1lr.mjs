...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    ...
    createElementVNode("path", { d: "m12 16 4-4-4-4M8 12h8" }, null, -1)
  ]));
}
const arrowRightCircle = { render() {
  return h(NuxtIcon, { icon: { render }, name: "arrow-right-circle" });
} };

export { arrowRightCircle as default, render };
//# sourceMappingURL=arrow-right-circle-DmXCh1lr.mjs.map
