...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    ...
    createElementVNode("path", { d: "M7 11V7a5 5 0 0 1 10 0v4" }, null, -1)
  ]));
}
const lock = { render() {
  return h(NuxtIcon, { icon: { render }, name: "lock" });
} };

export { lock as default, render };
//# sourceMappingURL=lock-hx1FJa6y.mjs.map
