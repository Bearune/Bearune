...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M23 4v6h-6M1 20v-6h6" }, null, -1),
    createElementVNode("path", { d: "M3.51 9a9 9 0 0 1 14.85-3.36L23 10M1 14l4.64 4.36A9 9 0 0 0 20.49 15" }, null, -1)
  ]));
}
const refreshCw = { render() {
  return h(NuxtIcon, { icon: { render }, name: "refresh-cw" });
} };

export { refreshCw as default, render };
//# sourceMappingURL=refresh-cw-BWZN0c8S.mjs.map
