...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M18 8h1a4 4 0 0 1 0 8h-1M2 8h16v9a4 4 0 0 1-4 4H6a4 4 0 0 1-4-4V8zM6 1v3M10 1v3M14 1v3" }, null, -1)
  ]));
}
const coffee = { render() {
  return h(NuxtIcon, { icon: { render }, name: "coffee" });
} };

export { coffee as default, render };
//# sourceMappingURL=coffee-C9u7gOBW.mjs.map
