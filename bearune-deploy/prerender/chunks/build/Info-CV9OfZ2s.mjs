...
import { ssrRenderAttrs, ssrRenderSlot } from 'file://C:/bearuneBlog/node_modules/vue/server-renderer/index.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "info border border-base-400 bg-base-200 p-4 mb-8 rounded-box flex flex-col gap-4" }, _attrs))} data-v-e489f494>`);
...
const Info = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-e489f494"]]);

export { Info as default };
//# sourceMappingURL=Info-CV9OfZ2s.mjs.map
