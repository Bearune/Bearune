...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    ...
    createElementVNode("path", { d: "m14.31 8 5.74 9.94M9.69 8h11.48M7.38 12l5.74-9.94M9.69 16 3.95 6.06M14.31 16H2.83M16.62 12l-5.74 9.94" }, null, -1)
  ]));
}
const aperture = { render() {
  return h(NuxtIcon, { icon: { render }, name: "aperture" });
} };

export { aperture as default, render };
//# sourceMappingURL=aperture-BRnr0ZLs.mjs.map
