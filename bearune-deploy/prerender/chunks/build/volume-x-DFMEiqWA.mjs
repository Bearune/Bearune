...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M11 5 6 9H2v6h4l5 4V5zM23 9l-6 6M17 9l6 6" }, null, -1)
  ]));
}
const volumeX = { render() {
  return h(NuxtIcon, { icon: { render }, name: "volume-x" });
} };

export { volumeX as default, render };
//# sourceMappingURL=volume-x-DFMEiqWA.mjs.map
