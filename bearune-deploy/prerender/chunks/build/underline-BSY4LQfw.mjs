...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M6 3v7a6 6 0 0 0 6 6 6 6 0 0 0 6-6V3M4 21h16" }, null, -1)
  ]));
}
const underline = { render() {
  return h(NuxtIcon, { icon: { render }, name: "underline" });
} };

export { underline as default, render };
//# sourceMappingURL=underline-BSY4LQfw.mjs.map
