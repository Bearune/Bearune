...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M4 15s1-1 4-1 5 2 8 2 4-1 4-1V3s-1 1-4 1-5-2-8-2-4 1-4 1zM4 22v-7" }, null, -1)
  ]));
}
const flag = { render() {
  return h(NuxtIcon, { icon: { render }, name: "flag" });
} };

export { flag as default, render };
//# sourceMappingURL=flag-vpMmie4r.mjs.map
