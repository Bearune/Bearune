...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "m8 17 4 4 4-4M12 12v9" }, null, -1),
    createElementVNode("path", { d: "M20.88 18.09A5 5 0 0 0 18 9h-1.26A8 8 0 1 0 3 16.29" }, null, -1)
  ]));
}
const downloadCloud = { render() {
  return h(NuxtIcon, { icon: { render }, name: "download-cloud" });
} };

export { downloadCloud as default, render };
//# sourceMappingURL=download-cloud-BB-JKcS_.mjs.map
