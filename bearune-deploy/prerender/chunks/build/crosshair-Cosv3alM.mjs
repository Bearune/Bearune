...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    ...
    createElementVNode("path", { d: "M22 12h-4M6 12H2M12 6V2M12 22v-4" }, null, -1)
  ]));
}
const crosshair = { render() {
  return h(NuxtIcon, { icon: { render }, name: "crosshair" });
} };

export { crosshair as default, render };
//# sourceMappingURL=crosshair-Cosv3alM.mjs.map
