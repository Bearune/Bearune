...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "m17 11-5-5-5 5M17 18l-5-5-5 5" }, null, -1)
  ]));
}
const chevronsUp = { render() {
  return h(NuxtIcon, { icon: { render }, name: "chevrons-up" });
} };

export { chevronsUp as default, render };
//# sourceMappingURL=chevrons-up-BSRtkOBD.mjs.map
