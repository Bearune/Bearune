...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "m3 11 19-9-9 19-2-8-8-2z" }, null, -1)
  ]));
}
const navigation = { render() {
  return h(NuxtIcon, { icon: { render }, name: "navigation" });
} };

export { navigation as default, render };
//# sourceMappingURL=navigation-Dk2Rw6Zz.mjs.map
