...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    ...
    createElementVNode("path", { d: "M10 15V9M14 15V9" }, null, -1)
  ]));
}
const pauseCircle = { render() {
  return h(NuxtIcon, { icon: { render }, name: "pause-circle" });
} };

export { pauseCircle as default, render };
//# sourceMappingURL=pause-circle-CLn_SvPN.mjs.map
