...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    ...
    createElementVNode("path", { d: "M16.24 7.76a6 6 0 0 1 0 8.49m-8.48-.01a6 6 0 0 1 0-8.49m11.31-2.82a10 10 0 0 1 0 14.14m-14.14 0a10 10 0 0 1 0-14.14" }, null, -1)
  ]));
}
const radio = { render() {
  return h(NuxtIcon, { icon: { render }, name: "radio" });
} };

export { radio as default, render };
//# sourceMappingURL=radio-Dl6EunTe.mjs.map
