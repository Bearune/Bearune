...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M18 20V10M12 20V4M6 20v-6" }, null, -1)
  ]));
}
const barChart2 = { render() {
  return h(NuxtIcon, { icon: { render }, name: "bar-chart-2" });
} };

export { barChart2 as default, render };
//# sourceMappingURL=bar-chart-2-CAKAlrdP.mjs.map
