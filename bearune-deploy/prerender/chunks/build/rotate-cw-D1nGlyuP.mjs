...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M23 4v6h-6" }, null, -1),
    createElementVNode("path", { d: "M20.49 15a9 9 0 1 1-2.12-9.36L23 10" }, null, -1)
  ]));
}
const rotateCw = { render() {
  return h(NuxtIcon, { icon: { render }, name: "rotate-cw" });
} };

export { rotateCw as default, render };
//# sourceMappingURL=rotate-cw-D1nGlyuP.mjs.map
