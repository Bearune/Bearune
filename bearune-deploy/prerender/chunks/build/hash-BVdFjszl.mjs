...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M4 9h16M4 15h16M10 3 8 21M16 3l-2 18" }, null, -1)
  ]));
}
const hash = { render() {
  return h(NuxtIcon, { icon: { render }, name: "hash" });
} };

export { hash as default, render };
//# sourceMappingURL=hash-BVdFjszl.mjs.map
