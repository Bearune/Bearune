...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M22 11.08V12a10 10 0 1 1-5.93-9.14" }, null, -1),
    createElementVNode("path", { d: "M22 4 12 14.01l-3-3" }, null, -1)
  ]));
}
const checkCircle = { render() {
  return h(NuxtIcon, { icon: { render }, name: "check-circle" });
} };

export { checkCircle as default, render };
//# sourceMappingURL=check-circle-CGkFpQri.mjs.map
