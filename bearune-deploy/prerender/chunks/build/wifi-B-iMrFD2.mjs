...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M5 12.55a11 11 0 0 1 14.08 0M1.42 9a16 16 0 0 1 21.16 0M8.53 16.11a6 6 0 0 1 6.95 0M12 20h.01" }, null, -1)
  ]));
}
const wifi = { render() {
  return h(NuxtIcon, { icon: { render }, name: "wifi" });
} };

export { wifi as default, render };
//# sourceMappingURL=wifi-B-iMrFD2.mjs.map
