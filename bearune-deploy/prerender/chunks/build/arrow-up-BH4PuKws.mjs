...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M12 19V5M5 12l7-7 7 7" }, null, -1)
  ]));
}
const arrowUp = { render() {
  return h(NuxtIcon, { icon: { render }, name: "arrow-up" });
} };

export { arrowUp as default, render };
//# sourceMappingURL=arrow-up-BH4PuKws.mjs.map
