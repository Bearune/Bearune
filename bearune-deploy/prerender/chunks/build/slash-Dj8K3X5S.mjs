...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    ...
    createElementVNode("path", { d: "m4.93 4.93 14.14 14.14" }, null, -1)
  ]));
}
const slash = { render() {
  return h(NuxtIcon, { icon: { render }, name: "slash" });
} };

export { slash as default, render };
//# sourceMappingURL=slash-Dj8K3X5S.mjs.map
