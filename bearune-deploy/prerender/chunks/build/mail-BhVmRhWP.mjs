...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z" }, null, -1),
    createElementVNode("path", { d: "m22 6-10 7L2 6" }, null, -1)
  ]));
}
const mail = { render() {
...
//# sourceMappingURL=mail-BhVmRhWP.mjs.map
