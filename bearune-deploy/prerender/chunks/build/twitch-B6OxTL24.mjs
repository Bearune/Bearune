...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M21 2H3v16h5v4l4-4h5l4-4V2zm-10 9V7m5 4V7" }, null, -1)
  ]));
}
const twitch = { render() {
  return h(NuxtIcon, { icon: { render }, name: "twitch" });
} };

export { twitch as default, render };
//# sourceMappingURL=twitch-B6OxTL24.mjs.map
