...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "m15 14 5-5-5-5" }, null, -1),
    createElementVNode("path", { d: "M4 20v-7a4 4 0 0 1 4-4h12" }, null, -1)
  ]));
}
const cornerUpRight = { render() {
  return h(NuxtIcon, { icon: { render }, name: "corner-up-right" });
} };

export { cornerUpRight as default, render };
//# sourceMappingURL=corner-up-right-fIKvMbJv.mjs.map
