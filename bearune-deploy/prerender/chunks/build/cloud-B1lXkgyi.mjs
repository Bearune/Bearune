...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M18 10h-1.26A8 8 0 1 0 9 20h9a5 5 0 0 0 0-10z" }, null, -1)
  ]));
}
const cloud = { render() {
  return h(NuxtIcon, { icon: { render }, name: "cloud" });
} };

export { cloud as default, render };
//# sourceMappingURL=cloud-B1lXkgyi.mjs.map
