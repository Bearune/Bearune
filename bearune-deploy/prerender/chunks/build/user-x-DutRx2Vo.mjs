...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    ...
    createElementVNode("path", { d: "m18 8 5 5M23 8l-5 5" }, null, -1)
  ]));
}
const userX = { render() {
  return h(NuxtIcon, { icon: { render }, name: "user-x" });
} };

export { userX as default, render };
//# sourceMappingURL=user-x-DutRx2Vo.mjs.map
