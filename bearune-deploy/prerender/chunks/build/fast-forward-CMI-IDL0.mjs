...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "m13 19 9-7-9-7v14zM2 19l9-7-9-7v14z" }, null, -1)
  ]));
}
const fastForward = { render() {
  return h(NuxtIcon, { icon: { render }, name: "fast-forward" });
} };

export { fastForward as default, render };
//# sourceMappingURL=fast-forward-CMI-IDL0.mjs.map
