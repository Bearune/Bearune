...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "m10 15 5 5 5-5" }, null, -1),
    createElementVNode("path", { d: "M4 4h7a4 4 0 0 1 4 4v12" }, null, -1)
  ]));
}
const cornerRightDown = { render() {
  return h(NuxtIcon, { icon: { render }, name: "corner-right-down" });
} };

export { cornerRightDown as default, render };
//# sourceMappingURL=corner-right-down-CwulujwW.mjs.map
