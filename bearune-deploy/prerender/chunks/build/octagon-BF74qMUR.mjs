...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M7.86 2h8.28L22 7.86v8.28L16.14 22H7.86L2 16.14V7.86L7.86 2z" }, null, -1)
  ]));
}
const octagon = { render() {
  return h(NuxtIcon, { icon: { render }, name: "octagon" });
} };

export { octagon as default, render };
//# sourceMappingURL=octagon-BF74qMUR.mjs.map
