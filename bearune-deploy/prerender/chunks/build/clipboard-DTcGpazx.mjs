...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2" }, null, -1),
...
const clipboard = { render() {
  return h(NuxtIcon, { icon: { render }, name: "clipboard" });
} };

export { clipboard as default, render };
//# sourceMappingURL=clipboard-DTcGpazx.mjs.map
