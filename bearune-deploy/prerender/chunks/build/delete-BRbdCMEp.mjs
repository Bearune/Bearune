...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M21 4H8l-7 8 7 8h13a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2zM18 9l-6 6M12 9l6 6" }, null, -1)
  ]));
}
const _delete = { render() {
  return h(NuxtIcon, { icon: { render }, name: "delete" });
} };

export { _delete as default, render };
//# sourceMappingURL=delete-BRbdCMEp.mjs.map
