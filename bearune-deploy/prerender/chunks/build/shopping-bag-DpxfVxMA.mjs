...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M6 2 3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4zM3 6h18" }, null, -1),
    createElementVNode("path", { d: "M16 10a4 4 0 0 1-8 0" }, null, -1)
  ]));
}
const shoppingBag = { render() {
  return h(NuxtIcon, { icon: { render }, name: "shopping-bag" });
} };

export { shoppingBag as default, render };
//# sourceMappingURL=shopping-bag-DpxfVxMA.mjs.map
