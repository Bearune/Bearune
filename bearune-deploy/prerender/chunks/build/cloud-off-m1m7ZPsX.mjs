...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M22.61 16.95A5 5 0 0 0 18 10h-1.26a8 8 0 0 0-7.05-6M5 5a8 8 0 0 0 4 15h9a5 5 0 0 0 1.7-.3M1 1l22 22" }, null, -1)
  ]));
}
const cloudOff = { render() {
  return h(NuxtIcon, { icon: { render }, name: "cloud-off" });
} };

export { cloudOff as default, render };
//# sourceMappingURL=cloud-off-m1m7ZPsX.mjs.map
