...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M6 9V2h12v7M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2" }, null, -1),
    createElementVNode("path", { d: "M6 14h12v8H6z" }, null, -1)
  ]));
}
const printer = { render() {
  return h(NuxtIcon, { icon: { render }, name: "printer" });
} };

export { printer as default, render };
//# sourceMappingURL=printer-9m5_DDtI.mjs.map
