...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2zM9 14h6" }, null, -1)
  ]));
}
const folderMinus = { render() {
  return h(NuxtIcon, { icon: { render }, name: "folder-minus" });
} };

export { folderMinus as default, render };
//# sourceMappingURL=folder-minus-nc5KU5pw.mjs.map
