...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2zM22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z" }, null, -1)
  ]));
}
const bookOpen = { render() {
  return h(NuxtIcon, { icon: { render }, name: "book-open" });
} };

export { bookOpen as default, render };
//# sourceMappingURL=book-open-gnrc066K.mjs.map
