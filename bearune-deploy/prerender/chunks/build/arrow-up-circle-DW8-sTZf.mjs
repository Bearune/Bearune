...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    ...
    createElementVNode("path", { d: "m16 12-4-4-4 4M12 16V8" }, null, -1)
  ]));
}
const arrowUpCircle = { render() {
  return h(NuxtIcon, { icon: { render }, name: "arrow-up-circle" });
} };

export { arrowUpCircle as default, render };
//# sourceMappingURL=arrow-up-circle-DW8-sTZf.mjs.map
