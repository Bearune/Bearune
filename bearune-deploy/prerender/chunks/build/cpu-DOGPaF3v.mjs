...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    ...
    createElementVNode("path", { d: "M9 9h6v6H9zM9 1v3M15 1v3M9 20v3M15 20v3M20 9h3M20 14h3M1 9h3M1 14h3" }, null, -1)
  ]));
}
const cpu = { render() {
  return h(NuxtIcon, { icon: { render }, name: "cpu" });
} };

export { cpu as default, render };
//# sourceMappingURL=cpu-DOGPaF3v.mjs.map
