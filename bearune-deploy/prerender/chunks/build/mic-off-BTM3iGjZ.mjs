...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "m1 1 22 22M9 9v3a3 3 0 0 0 5.12 2.12M15 9.34V4a3 3 0 0 0-5.94-.6" }, null, -1),
    createElementVNode("path", { d: "M17 16.95A7 7 0 0 1 5 12v-2m14 0v2a7 7 0 0 1-.11 1.23M12 19v4M8 23h8" }, null, -1)
  ]));
}
const micOff = { render() {
  return h(NuxtIcon, { icon: { render }, name: "mic-off" });
} };

export { micOff as default, render };
//# sourceMappingURL=mic-off-BTM3iGjZ.mjs.map
