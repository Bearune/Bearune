...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z" }, null, -1),
    createElementVNode("path", { d: "M9 22V12h6v10" }, null, -1)
  ]));
}
const home = { render() {
  return h(NuxtIcon, { icon: { render }, name: "home" });
} };

export { home as default, render };
//# sourceMappingURL=home-DCrlCQYV.mjs.map
