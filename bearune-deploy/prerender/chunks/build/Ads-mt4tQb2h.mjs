...
import { mergeProps, useSSRContext } from 'file://C:/bearuneBlog/node_modules/vue/index.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "ads-container" }, _attrs))}>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/content/Ads.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const Ads = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { Ads as default };
//# sourceMappingURL=Ads-mt4tQb2h.mjs.map
