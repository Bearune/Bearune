...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    ...
    createElementVNode("path", { d: "M12 6v6l4 2" }, null, -1)
  ]));
}
const clock = { render() {
  return h(NuxtIcon, { icon: { render }, name: "clock" });
} };

export { clock as default, render };
//# sourceMappingURL=clock-CXHND8dr.mjs.map
