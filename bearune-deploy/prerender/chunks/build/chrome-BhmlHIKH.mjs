...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    ...
    createElementVNode("path", { d: "M21.17 8H12M3.95 6.06 8.54 14M10.88 21.94 15.46 14" }, null, -1)
  ]));
}
const chrome = { render() {
  return h(NuxtIcon, { icon: { render }, name: "chrome" });
} };

export { chrome as default, render };
//# sourceMappingURL=chrome-BhmlHIKH.mjs.map
