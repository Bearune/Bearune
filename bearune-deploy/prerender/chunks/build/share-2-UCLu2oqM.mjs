...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    ...
    createElementVNode("path", { d: "m8.59 13.51 6.83 3.98M15.41 6.51l-6.82 3.98" }, null, -1)
  ]));
}
const share2 = { render() {
  return h(NuxtIcon, { icon: { render }, name: "share-2" });
} };

export { share2 as default, render };
//# sourceMappingURL=share-2-UCLu2oqM.mjs.map
