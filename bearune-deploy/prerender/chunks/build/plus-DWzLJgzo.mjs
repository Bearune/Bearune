...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M12 5v14M5 12h14" }, null, -1)
  ]));
}
const plus = { render() {
  return h(NuxtIcon, { icon: { render }, name: "plus" });
} };

export { plus as default, render };
//# sourceMappingURL=plus-DWzLJgzo.mjs.map
