...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "m1 1 22 22M21 21H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h3m3-3h6l2 3h4a2 2 0 0 1 2 2v9.34m-7.72-2.06a4 4 0 1 1-5.56-5.56" }, null, -1)
  ]));
}
const cameraOff = { render() {
  return h(NuxtIcon, { icon: { render }, name: "camera-off" });
} };

export { cameraOff as default, render };
//# sourceMappingURL=camera-off-BVV9D9em.mjs.map
