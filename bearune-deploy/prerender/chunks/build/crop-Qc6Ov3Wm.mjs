...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M6.13 1 6 16a2 2 0 0 0 2 2h15" }, null, -1),
    createElementVNode("path", { d: "M1 6.13 16 6a2 2 0 0 1 2 2v15" }, null, -1)
  ]));
}
const crop = { render() {
  return h(NuxtIcon, { icon: { render }, name: "crop" });
} };

export { crop as default, render };
//# sourceMappingURL=crop-Qc6Ov3Wm.mjs.map
