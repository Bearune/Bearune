...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "m10 9 5-5 5 5" }, null, -1),
    createElementVNode("path", { d: "M4 20h7a4 4 0 0 0 4-4V4" }, null, -1)
  ]));
}
const cornerRightUp = { render() {
  return h(NuxtIcon, { icon: { render }, name: "corner-right-up" });
} };

export { cornerRightUp as default, render };
//# sourceMappingURL=corner-right-up-DjhBTf5U.mjs.map
