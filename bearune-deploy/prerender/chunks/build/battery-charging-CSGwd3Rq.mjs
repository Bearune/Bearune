...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M5 18H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h3.19M15 6h2a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2h-3.19M23 13v-2M11 6l-4 6h6l-4 6" }, null, -1)
  ]));
}
const batteryCharging = { render() {
  return h(NuxtIcon, { icon: { render }, name: "battery-charging" });
} };

export { batteryCharging as default, render };
//# sourceMappingURL=battery-charging-CSGwd3Rq.mjs.map
