...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "m23 6-9.5 9.5-5-5L1 18" }, null, -1),
    createElementVNode("path", { d: "M17 6h6v6" }, null, -1)
  ]));
}
const trendingUp = { render() {
  return h(NuxtIcon, { icon: { render }, name: "trending-up" });
} };

export { trendingUp as default, render };
//# sourceMappingURL=trending-up-DNfWlwt_.mjs.map
