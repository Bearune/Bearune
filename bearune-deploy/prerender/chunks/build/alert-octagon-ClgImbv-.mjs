...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M7.86 2h8.28L22 7.86v8.28L16.14 22H7.86L2 16.14V7.86L7.86 2zM12 8v4M12 16h.01" }, null, -1)
  ]));
}
const alertOctagon = { render() {
  return h(NuxtIcon, { icon: { render }, name: "alert-octagon" });
} };

export { alertOctagon as default, render };
//# sourceMappingURL=alert-octagon-ClgImbv-.mjs.map
