...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M7 17 17 7M7 7h10v10" }, null, -1)
  ]));
}
const arrowUpRight = { render() {
  return h(NuxtIcon, { icon: { render }, name: "arrow-up-right" });
} };

export { arrowUpRight as default, render };
//# sourceMappingURL=arrow-up-right-DmiuMp45.mjs.map
