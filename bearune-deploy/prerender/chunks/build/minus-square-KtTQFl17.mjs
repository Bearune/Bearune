...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    ...
    createElementVNode("path", { d: "M8 12h8" }, null, -1)
  ]));
}
const minusSquare = { render() {
  return h(NuxtIcon, { icon: { render }, name: "minus-square" });
} };

export { minusSquare as default, render };
//# sourceMappingURL=minus-square-KtTQFl17.mjs.map
