...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M19 16.9A5 5 0 0 0 18 7h-1.26a8 8 0 1 0-11.62 9" }, null, -1),
    createElementVNode("path", { d: "m13 11-4 6h6l-4 6" }, null, -1)
  ]));
}
const cloudLightning = { render() {
  return h(NuxtIcon, { icon: { render }, name: "cloud-lightning" });
} };

export { cloudLightning as default, render };
//# sourceMappingURL=cloud-lightning-9jBNSCv0.mjs.map
