...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "m9 11 3 3L22 4" }, null, -1),
    createElementVNode("path", { d: "M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11" }, null, -1)
  ]));
}
const checkSquare = { render() {
  return h(NuxtIcon, { icon: { render }, name: "check-square" });
} };

export { checkSquare as default, render };
//# sourceMappingURL=check-square-DnFCntg8.mjs.map
