...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M3 3h7v7H3zM14 3h7v7h-7zM14 14h7v7h-7zM3 14h7v7H3z" }, null, -1)
  ]));
}
const grid = { render() {
  return h(NuxtIcon, { icon: { render }, name: "grid" });
} };

export { grid as default, render };
//# sourceMappingURL=grid-DihZKwt_.mjs.map
