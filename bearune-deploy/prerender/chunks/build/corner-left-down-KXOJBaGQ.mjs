...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "m14 15-5 5-5-5" }, null, -1),
    createElementVNode("path", { d: "M20 4h-7a4 4 0 0 0-4 4v12" }, null, -1)
  ]));
}
const cornerLeftDown = { render() {
  return h(NuxtIcon, { icon: { render }, name: "corner-left-down" });
} };

export { cornerLeftDown as default, render };
//# sourceMappingURL=corner-left-down-KXOJBaGQ.mjs.map
