...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "m16 16-4-4-4 4M12 12v9" }, null, -1),
...
const uploadCloud = { render() {
  return h(NuxtIcon, { icon: { render }, name: "upload-cloud" });
} };

export { uploadCloud as default, render };
//# sourceMappingURL=upload-cloud-CiMbnKWQ.mjs.map
