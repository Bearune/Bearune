...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M9.59 4.59A2 2 0 1 1 11 8H2m10.59 11.41A2 2 0 1 0 14 16H2m15.73-8.27A2.5 2.5 0 1 1 19.5 12H2" }, null, -1)
  ]));
}
const wind = { render() {
  return h(NuxtIcon, { icon: { render }, name: "wind" });
} };

export { wind as default, render };
//# sourceMappingURL=wind-v0c2sfv6.mjs.map
