...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M11 5 6 9H2v6h4l5 4V5zM15.54 8.46a5 5 0 0 1 0 7.07" }, null, -1)
  ]));
}
const volume1 = { render() {
  return h(NuxtIcon, { icon: { render }, name: "volume-1" });
} };

export { volume1 as default, render };
//# sourceMappingURL=volume-1-CgSL1EFM.mjs.map
