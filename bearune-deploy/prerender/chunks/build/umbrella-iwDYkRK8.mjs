...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M23 12a11.05 11.05 0 0 0-22 0zm-5 7a3 3 0 0 1-6 0v-7" }, null, -1)
  ]));
}
const umbrella = { render() {
  return h(NuxtIcon, { icon: { render }, name: "umbrella" });
} };

export { umbrella as default, render };
//# sourceMappingURL=umbrella-iwDYkRK8.mjs.map
