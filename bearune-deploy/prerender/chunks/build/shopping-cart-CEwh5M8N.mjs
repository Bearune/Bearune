...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    ...
    createElementVNode("path", { d: "M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6" }, null, -1)
  ]));
}
const shoppingCart = { render() {
  return h(NuxtIcon, { icon: { render }, name: "shopping-cart" });
} };

export { shoppingCart as default, render };
//# sourceMappingURL=shopping-cart-CEwh5M8N.mjs.map
