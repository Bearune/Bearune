...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M9 18V5l12-2v13" }, null, -1),
...
const music = { render() {
  return h(NuxtIcon, { icon: { render }, name: "music" });
} };

export { music as default, render };
//# sourceMappingURL=music-C_UqqQ5r.mjs.map
