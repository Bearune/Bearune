...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2" }, null, -1),
    createElementVNode("circle", {
      cx: "9",
      cy: "7",
      r: "4"
    }, null, -1),
    createElementVNode("path", { d: "M23 21v-2a4 4 0 0 0-3-3.87M16 3.13a4 4 0 0 1 0 7.75" }, null, -1)
  ]));
}
const users = { render() {
  return h(NuxtIcon, { icon: { render }, name: "users" });
} };

export { users as default, render };
//# sourceMappingURL=users-B8pfnkIR.mjs.map
