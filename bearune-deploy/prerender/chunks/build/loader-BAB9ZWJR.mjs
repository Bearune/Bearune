...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M12 2v4M12 18v4M4.93 4.93l2.83 2.83M16.24 16.24l2.83 2.83M2 12h4M18 12h4M4.93 19.07l2.83-2.83M16.24 7.76l2.83-2.83" }, null, -1)
  ]));
}
const loader = { render() {
  return h(NuxtIcon, { icon: { render }, name: "loader" });
} };

export { loader as default, render };
//# sourceMappingURL=loader-BAB9ZWJR.mjs.map
