...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    ...
    createElementVNode("path", { d: "M13 6h3a2 2 0 0 1 2 2v7M6 9v12" }, null, -1)
  ]));
}
const gitPullRequest = { render() {
  return h(NuxtIcon, { icon: { render }, name: "git-pull-request" });
} };

export { gitPullRequest as default, render };
//# sourceMappingURL=git-pull-request-PGgWIFy3.mjs.map
