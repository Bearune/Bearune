...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M13 2 3 14h9l-1 8 10-12h-9l1-8z" }, null, -1)
  ]));
}
const zap = { render() {
  return h(NuxtIcon, { icon: { render }, name: "zap" });
} };

export { zap as default, render };
//# sourceMappingURL=zap-Wob6LOVV.mjs.map
