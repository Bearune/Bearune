...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    ...
    createElementVNode("path", { d: "M7 11V7a5 5 0 0 1 9.9-1" }, null, -1)
  ]));
}
const unlock = { render() {
  return h(NuxtIcon, { icon: { render }, name: "unlock" });
} };

export { unlock as default, render };
//# sourceMappingURL=unlock-DrzfAQ9W.mjs.map
