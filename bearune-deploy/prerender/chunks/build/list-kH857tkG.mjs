...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M8 6h13M8 12h13M8 18h13M3 6h.01M3 12h.01M3 18h.01" }, null, -1)
  ]));
}
const list = { render() {
  return h(NuxtIcon, { icon: { render }, name: "list" });
} };

export { list as default, render };
//# sourceMappingURL=list-kH857tkG.mjs.map
