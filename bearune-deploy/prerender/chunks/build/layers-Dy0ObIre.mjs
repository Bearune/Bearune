...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M12 2 2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5" }, null, -1)
  ]));
}
const layers = { render() {
  return h(NuxtIcon, { icon: { render }, name: "layers" });
} };

export { layers as default, render };
//# sourceMappingURL=layers-Dy0ObIre.mjs.map
