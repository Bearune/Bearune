...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    ...
    createElementVNode("path", { d: "M20 4 8.12 15.88M14.47 14.48 20 20M8.12 8.12 12 12" }, null, -1)
  ]));
}
const scissors = { render() {
  return h(NuxtIcon, { icon: { render }, name: "scissors" });
} };

export { scissors as default, render };
//# sourceMappingURL=scissors-CX42U9z3.mjs.map
