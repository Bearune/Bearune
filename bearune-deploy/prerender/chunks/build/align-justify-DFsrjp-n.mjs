...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M21 10H3M21 6H3M21 14H3M21 18H3" }, null, -1)
  ]));
}
const alignJustify = { render() {
  return h(NuxtIcon, { icon: { render }, name: "align-justify" });
} };

export { alignJustify as default, render };
//# sourceMappingURL=align-justify-DFsrjp-n.mjs.map
