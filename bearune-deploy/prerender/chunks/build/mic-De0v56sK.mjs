...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M12 1a3 3 0 0 0-3 3v8a3 3 0 0 0 6 0V4a3 3 0 0 0-3-3z" }, null, -1),
    createElementVNode("path", { d: "M19 10v2a7 7 0 0 1-14 0v-2M12 19v4M8 23h8" }, null, -1)
  ]));
}
const mic = { render() {
  return h(NuxtIcon, { icon: { render }, name: "mic" });
} };

export { mic as default, render };
//# sourceMappingURL=mic-De0v56sK.mjs.map
