...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    ...
    createElementVNode("path", { d: "M12 18h.01" }, null, -1)
  ]));
}
const smartphone = { render() {
  return h(NuxtIcon, { icon: { render }, name: "smartphone" });
} };

export { smartphone as default, render };
//# sourceMappingURL=smartphone-DSoge9Ru.mjs.map
