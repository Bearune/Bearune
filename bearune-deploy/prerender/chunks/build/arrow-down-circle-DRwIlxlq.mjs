...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    ...
    createElementVNode("path", { d: "m8 12 4 4 4-4M12 8v8" }, null, -1)
  ]));
}
const arrowDownCircle = { render() {
  return h(NuxtIcon, { icon: { render }, name: "arrow-down-circle" });
} };

export { arrowDownCircle as default, render };
//# sourceMappingURL=arrow-down-circle-DRwIlxlq.mjs.map
