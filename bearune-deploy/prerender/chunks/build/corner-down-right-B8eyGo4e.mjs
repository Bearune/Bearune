...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "m15 10 5 5-5 5" }, null, -1),
    createElementVNode("path", { d: "M4 4v7a4 4 0 0 0 4 4h12" }, null, -1)
  ]));
}
const cornerDownRight = { render() {
  return h(NuxtIcon, { icon: { render }, name: "corner-down-right" });
} };

export { cornerDownRight as default, render };
//# sourceMappingURL=corner-down-right-B8eyGo4e.mjs.map
