...
const minusCircle = { render() {
  return h(NuxtIcon, { icon: { render }, name: "minus-circle" });
} };

export { minusCircle as default, render };
//# sourceMappingURL=minus-circle-D81lgMW1.mjs.map
