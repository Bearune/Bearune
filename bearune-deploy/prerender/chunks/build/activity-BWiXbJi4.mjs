...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M22 12h-4l-3 9L9 3l-3 9H2" }, null, -1)
  ]));
}
const activity = { render() {
  return h(NuxtIcon, { icon: { render }, name: "activity" });
} };

export { activity as default, render };
//# sourceMappingURL=activity-BWiXbJi4.mjs.map
