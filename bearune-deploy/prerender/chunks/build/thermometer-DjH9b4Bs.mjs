...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M14 14.76V3.5a2.5 2.5 0 0 0-5 0v11.26a4.5 4.5 0 1 0 5 0z" }, null, -1)
  ]));
}
const thermometer = { render() {
  return h(NuxtIcon, { icon: { render }, name: "thermometer" });
} };

export { thermometer as default, render };
//# sourceMappingURL=thermometer-DjH9b4Bs.mjs.map
