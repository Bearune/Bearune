import { withLeadingSlash, joinURL, withoutTrailingSlash, withBase } from 'file://C:/bearuneBlog/node_modules/ufo/dist/index.mjs';
import { hash } from 'file://C:/bearuneBlog/node_modules/ohash/dist/index.mjs';
import { e as useRuntimeConfig, C as useRequestEvent } from './server.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-BUP39D3x.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-BfItlduj.mjs.map
