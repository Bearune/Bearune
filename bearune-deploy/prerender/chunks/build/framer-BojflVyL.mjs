...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M5 16V9h14V2H5l14 14h-7m-7 0 7 7v-7m-7 0h7" }, null, -1)
  ]));
}
const framer = { render() {
  return h(NuxtIcon, { icon: { render }, name: "framer" });
} };

export { framer as default, render };
//# sourceMappingURL=framer-BojflVyL.mjs.map
