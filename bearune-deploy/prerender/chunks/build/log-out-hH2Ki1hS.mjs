...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4M16 17l5-5-5-5M21 12H9" }, null, -1)
  ]));
}
const logOut = { render() {
  return h(NuxtIcon, { icon: { render }, name: "log-out" });
} };

export { logOut as default, render };
//# sourceMappingURL=log-out-hH2Ki1hS.mjs.map
