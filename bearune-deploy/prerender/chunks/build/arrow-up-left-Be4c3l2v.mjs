...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M17 17 7 7M7 17V7h10" }, null, -1)
  ]));
}
const arrowUpLeft = { render() {
  return h(NuxtIcon, { icon: { render }, name: "arrow-up-left" });
} };

export { arrowUpLeft as default, render };
//# sourceMappingURL=arrow-up-left-Be4c3l2v.mjs.map
