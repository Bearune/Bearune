...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    ...
    createElementVNode("path", { d: "M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37zM17.5 6.5h.01" }, null, -1)
  ]));
}
const instagram = { render() {
  return h(NuxtIcon, { icon: { render }, name: "instagram" });
} };

export { instagram as default, render };
//# sourceMappingURL=instagram-nezc2Ynh.mjs.map
