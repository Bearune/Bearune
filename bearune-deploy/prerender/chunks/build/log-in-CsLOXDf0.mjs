...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M15 3h4a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-4M10 17l5-5-5-5M15 12H3" }, null, -1)
  ]));
}
const logIn = { render() {
  return h(NuxtIcon, { icon: { render }, name: "log-in" });
} };

export { logIn as default, render };
//# sourceMappingURL=log-in-CsLOXDf0.mjs.map
