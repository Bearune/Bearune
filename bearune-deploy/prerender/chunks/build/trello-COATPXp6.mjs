...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    ...
    createElementVNode("path", { d: "M7 7h3v9H7zM14 7h3v5h-3z" }, null, -1)
  ]));
}
const trello = { render() {
  return h(NuxtIcon, { icon: { render }, name: "trello" });
} };

export { trello as default, render };
//# sourceMappingURL=trello-COATPXp6.mjs.map
