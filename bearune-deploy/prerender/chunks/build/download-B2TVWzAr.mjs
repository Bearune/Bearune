...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4M7 10l5 5 5-5M12 15V3" }, null, -1)
  ]));
}
const download = { render() {
  return h(NuxtIcon, { icon: { render }, name: "download" });
} };

export { download as default, render };
//# sourceMappingURL=download-B2TVWzAr.mjs.map
