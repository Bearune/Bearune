...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M15 3h6v6M9 21H3v-6M21 3l-7 7M3 21l7-7" }, null, -1)
  ]));
}
const maximize2 = { render() {
  return h(NuxtIcon, { icon: { render }, name: "maximize-2" });
} };

export { maximize2 as default, render };
//# sourceMappingURL=maximize-2-CZVdeDOC.mjs.map
