...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    ...
    createElementVNode("path", { d: "M2 12h20M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z" }, null, -1)
  ]));
}
const globe = { render() {
  return h(NuxtIcon, { icon: { render }, name: "globe" });
} };

export { globe as default, render };
//# sourceMappingURL=globe-Cun1msxw.mjs.map
