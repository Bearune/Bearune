...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6zM2 9h4v12H2z" }, null, -1),
...
const linkedin = { render() {
  return h(NuxtIcon, { icon: { render }, name: "linkedin" });
} };

export { linkedin as default, render };
//# sourceMappingURL=linkedin-RyDM4yY5.mjs.map
