...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    ...
    createElementVNode("path", { d: "M8.21 13.89 7 23l5-3 5 3-1.21-9.12" }, null, -1)
  ]));
}
const award = { render() {
  return h(NuxtIcon, { icon: { render }, name: "award" });
} };

export { award as default, render };
//# sourceMappingURL=award-ClHCVeSJ.mjs.map
