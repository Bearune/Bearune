...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M18 6 6 18M6 6l12 12" }, null, -1)
  ]));
}
const x = { render() {
  return h(NuxtIcon, { icon: { render }, name: "x" });
} };

export { x as default, render };
//# sourceMappingURL=x-DqTgFTmB.mjs.map
