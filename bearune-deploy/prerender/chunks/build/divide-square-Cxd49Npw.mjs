...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    ...
    createElementVNode("path", { d: "M8 12h8M12 16h0M12 8h0" }, null, -1)
  ]));
}
const divideSquare = { render() {
  return h(NuxtIcon, { icon: { render }, name: "divide-square" });
} };

export { divideSquare as default, render };
//# sourceMappingURL=divide-square-Cxd49Npw.mjs.map
