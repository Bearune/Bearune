...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M15 7h3a5 5 0 0 1 5 5 5 5 0 0 1-5 5h-3m-6 0H6a5 5 0 0 1-5-5 5 5 0 0 1 5-5h3M8 12h8" }, null, -1)
  ]));
}
const link2 = { render() {
  return h(NuxtIcon, { icon: { render }, name: "link-2" });
} };

export { link2 as default, render };
//# sourceMappingURL=link-2-Bb-bVsia.mjs.map
