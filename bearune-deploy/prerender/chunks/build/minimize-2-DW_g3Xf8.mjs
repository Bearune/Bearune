...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M4 14h6v6M20 10h-6V4M14 10l7-7M3 21l7-7" }, null, -1)
  ]));
}
const minimize2 = { render() {
  return h(NuxtIcon, { icon: { render }, name: "minimize-2" });
} };

export { minimize2 as default, render };
//# sourceMappingURL=minimize-2-DW_g3Xf8.mjs.map
