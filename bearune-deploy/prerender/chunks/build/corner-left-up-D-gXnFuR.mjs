...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M14 9 9 4 4 9" }, null, -1),
    createElementVNode("path", { d: "M20 20h-7a4 4 0 0 1-4-4V4" }, null, -1)
  ]));
}
const cornerLeftUp = { render() {
  return h(NuxtIcon, { icon: { render }, name: "corner-left-up" });
} };

export { cornerLeftUp as default, render };
//# sourceMappingURL=corner-left-up-D-gXnFuR.mjs.map
