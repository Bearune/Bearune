...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M21 8v13H3V8M1 3h22v5H1zM10 12h4" }, null, -1)
  ]));
}
const archive = { render() {
  return h(NuxtIcon, { icon: { render }, name: "archive" });
} };

export { archive as default, render };
//# sourceMappingURL=archive-CEsf50dR.mjs.map
