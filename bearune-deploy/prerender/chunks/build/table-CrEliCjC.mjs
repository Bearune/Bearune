...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M9 3H5a2 2 0 0 0-2 2v4m6-6h10a2 2 0 0 1 2 2v4M9 3v18m0 0h10a2 2 0 0 0 2-2V9M9 21H5a2 2 0 0 1-2-2V9m0 0h18" }, null, -1)
  ]));
}
const table = { render() {
  return h(NuxtIcon, { icon: { render }, name: "table" });
} };

export { table as default, render };
//# sourceMappingURL=table-CrEliCjC.mjs.map
