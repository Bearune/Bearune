...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    ...
    createElementVNode("path", { d: "m21 15-5-5L5 21" }, null, -1)
  ]));
}
const image = { render() {
  return h(NuxtIcon, { icon: { render }, name: "image" });
} };

export { image as default, render };
//# sourceMappingURL=image-C24jw-KO.mjs.map
