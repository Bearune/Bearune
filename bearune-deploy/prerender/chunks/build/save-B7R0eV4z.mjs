...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M19 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11l5 5v11a2 2 0 0 1-2 2z" }, null, -1),
    createElementVNode("path", { d: "M17 21v-8H7v8M7 3v5h8" }, null, -1)
  ]));
}
const save = { render() {
  return h(NuxtIcon, { icon: { render }, name: "save" });
} };

export { save as default, render };
//# sourceMappingURL=save-B7R0eV4z.mjs.map
