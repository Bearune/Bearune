...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M8 19v2M8 13v2M16 19v2M16 13v2M12 21v2M12 15v2M20 16.58A5 5 0 0 0 18 7h-1.26A8 8 0 1 0 4 15.25" }, null, -1)
  ]));
}
const cloudDrizzle = { render() {
  return h(NuxtIcon, { icon: { render }, name: "cloud-drizzle" });
} };

export { cloudDrizzle as default, render };
//# sourceMappingURL=cloud-drizzle-CJKHpaAG.mjs.map
