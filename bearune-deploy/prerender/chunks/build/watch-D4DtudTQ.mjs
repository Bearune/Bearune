...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    ...
    createElementVNode("path", { d: "M12 9v3l1.5 1.5M16.51 17.35l-.35 3.83a2 2 0 0 1-2 1.82H9.83a2 2 0 0 1-2-1.82l-.35-3.83m.01-10.7.35-3.83A2 2 0 0 1 9.83 1h4.35a2 2 0 0 1 2 1.82l.35 3.83" }, null, -1)
  ]));
}
const watch = { render() {
  return h(NuxtIcon, { icon: { render }, name: "watch" });
} };

export { watch as default, render };
//# sourceMappingURL=watch-D4DtudTQ.mjs.map
