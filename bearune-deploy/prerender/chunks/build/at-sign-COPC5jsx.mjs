...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    ...
    createElementVNode("path", { d: "M16 8v5a3 3 0 0 0 6 0v-1a10 10 0 1 0-3.92 7.94" }, null, -1)
  ]));
}
const atSign = { render() {
  return h(NuxtIcon, { icon: { render }, name: "at-sign" });
} };

export { atSign as default, render };
//# sourceMappingURL=at-sign-COPC5jsx.mjs.map
