...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "m17 1 4 4-4 4" }, null, -1),
    createElementVNode("path", { d: "M3 11V9a4 4 0 0 1 4-4h14M7 23l-4-4 4-4" }, null, -1),
    createElementVNode("path", { d: "M21 13v2a4 4 0 0 1-4 4H3" }, null, -1)
  ]));
}
const repeat = { render() {
  return h(NuxtIcon, { icon: { render }, name: "repeat" });
} };

export { repeat as default, render };
//# sourceMappingURL=repeat-BcdrNUvC.mjs.map
