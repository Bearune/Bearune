...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    ...
    createElementVNode("path", { d: "m4.93 4.93 4.24 4.24M14.83 14.83l4.24 4.24M14.83 9.17l4.24-4.24M14.83 9.17l3.53-3.53M4.93 19.07l4.24-4.24" }, null, -1)
  ]));
}
const lifeBuoy = { render() {
  return h(NuxtIcon, { icon: { render }, name: "life-buoy" });
} };

export { lifeBuoy as default, render };
//# sourceMappingURL=life-buoy-7Yl4M7hd.mjs.map
