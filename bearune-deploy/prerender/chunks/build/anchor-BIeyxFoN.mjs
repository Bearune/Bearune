...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    ...
    createElementVNode("path", { d: "M12 22V8M5 12H2a10 10 0 0 0 20 0h-3" }, null, -1)
  ]));
}
const anchor = { render() {
  return h(NuxtIcon, { icon: { render }, name: "anchor" });
} };

export { anchor as default, render };
//# sourceMappingURL=anchor-BIeyxFoN.mjs.map
