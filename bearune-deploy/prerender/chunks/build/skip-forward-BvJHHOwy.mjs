...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "m5 4 10 8-10 8V4zM19 5v14" }, null, -1)
  ]));
}
const skipForward = { render() {
  return h(NuxtIcon, { icon: { render }, name: "skip-forward" });
} };

export { skipForward as default, render };
//# sourceMappingURL=skip-forward-BvJHHOwy.mjs.map
