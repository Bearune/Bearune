...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9M13.73 21a2 2 0 0 1-3.46 0" }, null, -1)
  ]));
}
const bell = { render() {
  return h(NuxtIcon, { icon: { render }, name: "bell" });
} };

export { bell as default, render };
//# sourceMappingURL=bell-kb5wi4f9.mjs.map
