...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    ...
    createElementVNode("path", { d: "m16.24 7.76-2.12 6.36-6.36 2.12 2.12-6.36 6.36-2.12z" }, null, -1)
  ]));
}
const compass = { render() {
  return h(NuxtIcon, { icon: { render }, name: "compass" });
} };

export { compass as default, render };
//# sourceMappingURL=compass-C1i5AiJ9.mjs.map
