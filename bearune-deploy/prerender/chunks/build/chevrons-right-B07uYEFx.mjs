...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "m13 17 5-5-5-5M6 17l5-5-5-5" }, null, -1)
  ]));
}
const chevronsRight = { render() {
  return h(NuxtIcon, { icon: { render }, name: "chevrons-right" });
} };

export { chevronsRight as default, render };
//# sourceMappingURL=chevrons-right-B07uYEFx.mjs.map
