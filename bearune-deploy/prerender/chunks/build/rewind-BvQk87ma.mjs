...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "m11 19-9-7 9-7v14zM22 19l-9-7 9-7v14z" }, null, -1)
  ]));
}
const rewind = { render() {
  return h(NuxtIcon, { icon: { render }, name: "rewind" });
} };

export { rewind as default, render };
//# sourceMappingURL=rewind-BvQk87ma.mjs.map
