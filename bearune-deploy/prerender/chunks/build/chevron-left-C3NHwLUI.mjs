...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "m15 18-6-6 6-6" }, null, -1)
  ]));
}
const chevronLeft = { render() {
  return h(NuxtIcon, { icon: { render }, name: "chevron-left" });
} };

export { chevronLeft as default, render };
//# sourceMappingURL=chevron-left-C3NHwLUI.mjs.map
