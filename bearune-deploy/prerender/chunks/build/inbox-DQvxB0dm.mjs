...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M22 12h-6l-2 3h-4l-2-3H2" }, null, -1),
    createElementVNode("path", { d: "M5.45 5.11 2 12v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-6l-3.45-6.89A2 2 0 0 0 16.76 4H7.24a2 2 0 0 0-1.79 1.11z" }, null, -1)
  ]));
}
const inbox = { render() {
  return h(NuxtIcon, { icon: { render }, name: "inbox" });
} };

export { inbox as default, render };
//# sourceMappingURL=inbox-DQvxB0dm.mjs.map
