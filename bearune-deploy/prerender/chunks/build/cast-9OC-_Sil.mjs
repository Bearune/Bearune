...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M2 16.1A5 5 0 0 1 5.9 20M2 12.05A9 9 0 0 1 9.95 20M2 8V6a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2h-6M2 20h.01" }, null, -1)
  ]));
}
const cast = { render() {
  return h(NuxtIcon, { icon: { render }, name: "cast" });
} };

export { cast as default, render };
//# sourceMappingURL=cast-9OC-_Sil.mjs.map
