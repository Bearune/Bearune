...
import { useSSRContext } from 'file://C:/bearuneBlog/node_modules/vue/index.mjs';
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/content/Client.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const Client = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { Client as default };
//# sourceMappingURL=Client-CisMqavp.mjs.map
