...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M21.21 15.89A10 10 0 1 1 8 2.83" }, null, -1),
    createElementVNode("path", { d: "M22 12A10 10 0 0 0 12 2v10z" }, null, -1)
  ]));
}
const pieChart = { render() {
  return h(NuxtIcon, { icon: { render }, name: "pie-chart" });
} };

export { pieChart as default, render };
//# sourceMappingURL=pie-chart-A_MZLR-J.mjs.map
