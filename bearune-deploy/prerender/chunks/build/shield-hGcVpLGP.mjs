...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" }, null, -1)
  ]));
}
const shield = { render() {
  return h(NuxtIcon, { icon: { render }, name: "shield" });
} };

export { shield as default, render };
//# sourceMappingURL=shield-hGcVpLGP.mjs.map
