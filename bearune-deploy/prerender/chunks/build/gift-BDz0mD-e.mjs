...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M20 12v10H4V12M2 7h20v5H2zM12 22V7M12 7H7.5a2.5 2.5 0 0 1 0-5C11 2 12 7 12 7zM12 7h4.5a2.5 2.5 0 0 0 0-5C13 2 12 7 12 7z" }, null, -1)
  ]));
}
const gift = { render() {
  return h(NuxtIcon, { icon: { render }, name: "gift" });
} };

export { gift as default, render };
//# sourceMappingURL=gift-BDz0mD-e.mjs.map
