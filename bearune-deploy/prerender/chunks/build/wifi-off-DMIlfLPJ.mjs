...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "m1 1 22 22M16.72 11.06A10.94 10.94 0 0 1 19 12.55M5 12.55a10.94 10.94 0 0 1 5.17-2.39M10.71 5.05A16 16 0 0 1 22.58 9M1.42 9a15.91 15.91 0 0 1 4.7-2.88M8.53 16.11a6 6 0 0 1 6.95 0M12 20h.01" }, null, -1)
  ]));
}
const wifiOff = { render() {
  return h(NuxtIcon, { icon: { render }, name: "wifi-off" });
} };

export { wifiOff as default, render };
//# sourceMappingURL=wifi-off-DMIlfLPJ.mjs.map
