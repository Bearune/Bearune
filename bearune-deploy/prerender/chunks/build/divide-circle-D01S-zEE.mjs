...
const divideCircle = { render() {
  return h(NuxtIcon, { icon: { render }, name: "divide-circle" });
} };

export { divideCircle as default, render };
//# sourceMappingURL=divide-circle-D01S-zEE.mjs.map
