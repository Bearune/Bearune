import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { createError, getQuery, handleCacheHeaders, setHeaders, setHeader, setResponseHeader, proxyRequest, sendRedirect, H3Error } from 'file://C:/bearuneBlog/node_modules/h3/dist/index.mjs';
import { withTrailingSlash, parseURL } from 'file://C:/bearuneBlog/node_modules/ufo/dist/index.mjs';
import { a as useOgImageRuntimeConfig, f as fetchIsland, n as normaliseFontInput, b as theme, c as useStorage, r as resolveContext } from './nitro.mjs';
import { a as applyEmojis, b as assets } from './emojis.mjs';
import { renderSSRHead } from 'file://C:/bearuneBlog/node_modules/@unhead/ssr/dist/index.mjs';
import { createHeadCore } from 'file://C:/bearuneBlog/node_modules/unhead/dist/index.mjs';
import { hash } from 'file://C:/bearuneBlog/node_modules/ohash/dist/index.mjs';
import { prefixStorage } from 'file://C:/bearuneBlog/node_modules/unstorage/dist/index.mjs';
